...
class NumToWordFrench
{
    ...
    public function __construct(string $amount, ?string $currency = null)
    {
        ...
        if ($currency === null) {
            $currency = 'EUR'; // maintain old behaviour from an initially released version of this class
        }

        $this->currency_word = _l('num_word_' . mb_strtoupper($currency, 'UTF-8'));
    }
