...
class MandiPurchOrder_pdf extends App_pdf
{
    protected $invoice;
    ...
    protected function file_path()
    {
        ...
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_MandiPurchOrderpdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/MandiPurchOrderpdf.php';
