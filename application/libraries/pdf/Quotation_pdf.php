...
class Quotation_pdf extends App_pdf
{
    ...
    protected function file_path()
    {
        ...
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/my_Quotationpdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/Quotationpdf.php';
