...
class PurchInvoice_pdf extends App_pdf
{
    protected $invoice;
    ...
    protected function file_path()
    {
        ...
        $customPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/PurchInvoicepdf.php';
        $actualPath = APPPATH . 'views/themes/' . active_clients_theme() . '/views/PurchInvoicepdf.php';
