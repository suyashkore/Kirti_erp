    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel_s">
          ...
          <div class="row">
              <div class="col-md-12">
              <h4 class="no-margin font-bold">Staff List</h4>
              </div>
...
<script>
  $(function(){
   ...
   var CustomersServerParams = {};
    ...
    var tAPI = initDataTable('.table-route-table', admin_url+'Accounts_master/staff_table', notSortableAndSearchableItemColumns, notSortableAndSearchableItemColumns,CustomersServerParams,[1,'asc']);
