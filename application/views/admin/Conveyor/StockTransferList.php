            ...
            <form action="" method="post" id="filter_list_form">
              <div class="row">
                ...
                <div class="col-md-9 mbot5" style="padding-top: 20px;">
                  <button type="submit" class="btn btn-success <?= (has_permission_new('salesOrderList', '', 'view')) ? '' : 'disabled'; ?>" id="searchBtn"><i class="fa fa-list"></i> Show</button>
                  <button type="button" class="btn btn-info exportBtn <?= (has_permission_new('salesOrderList', '', 'export')) ? '' : 'disabled'; ?>" onclick="exportTableToExcel()" style="display: none;"><i class="fa fa-file-excel"></i> Excel</button>
                  <button type="button" class="btn btn-info exportBtn <?= (has_permission_new('salesOrderList', '', 'print')) ? '' : 'disabled'; ?>" onclick="printPage();" style="display: none;"><i class="fa fa-print"></i> Print</button>
                </div>
