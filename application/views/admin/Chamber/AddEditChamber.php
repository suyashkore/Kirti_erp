        ...
        <div class="panel_s">
		  ...
		  <nav aria-label="breadcrumb">
            				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
            					...
            					<li class="breadcrumb-item active" aria-current="page"><b>Chamber Master</b></li>
							</ol>
						</nav>
                        <hr class="hr_style">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="searchh3" style="display:none;">Please wait Create new Chamber...</div>
                        <div class="searchh4" style="display:none;">Please wait update Chamber...</div>
                    </div>
                    <br>
                    <div class="col-md-3">
						<div class="form-group" app-field-wrapper="ChamberCode">
                            <small class="req text-danger">* </small>
                            <label for="ChamberCode" class="control-label">Chamber Code</label>
                            <input type="text" id="ChamberCode" name="ChamberCode" class="form-control" value="" oninput="this.value = this.value.replace(/[^A-Za-z0-9]/g, '')" required>
                        </div>
                    </div>
                    <div class="col-md-3">
								<div class="form-group">
									...
									<input type="text" name="ChamberName" id="ChamberName" class="form-control" value="" required>
                            ...
                            <div class="col-md-3">
								<div class="form-group">
									...
									<select class="selectpicker display-block" data-width="100%" id="GodownName" name="GodownName" data-live-search="true">
                    ...
                    <div class="col-md-12">
                                <div class="action-buttons text-left">
                                    <?php if (has_permission('Chamber', '', 'create')) {
                                    ?>
                                    ...
                                    <?php if (has_permission('Chamber', '', 'edit')) {
                                    ?>
            ...
            <!-- Iteme List Model-->
                ...
                <div class="modal fade ChamberMaster_List" id="ChamberMaster_List" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                        <div class="modal-header" style="padding:5px 10px;">
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <h4 class="modal-title">Chamber Master List</h4>
                        </div>
                        <div class="modal-body" style="padding:0px 5px !important">
                            
                            <div class="table-ChamberMaster_List tableFixHead2">
                                <table class="tree table table-striped table-bordered table-ChamberMaster_List tableFixHead2" id="table_ChamberMaster_List" width="100%">
                                    <thead>
                                        <tr>
                                            <th  class="sortablePop" style="text-align:left;">Chamber Code </th>
                                    ...
                                    <tbody id="ChamberMastertableBody">
                                    <?php
                                    foreach ($table_data as $key => $value) {
                                    ?>
                                        <tr class="get_ChamberMaster" data-id="<?php echo $value["ChamberCode"]; ?>">
                                           <td><?php echo $value["ChamberCode"]; ?></td>
...
$('#length, #Width, #Height, #Margin').on('input', function () {
    ...
    $(document).ready(function(){
        $('.updateBtn').hide();
        $('.updateBtn2').hide();
        $("#ChamberCode").dblclick(function(){
            $('#ChamberMaster_List').modal('show');
            $('#ChamberMaster_List').on('shown.bs.modal', function () {
              $('#myInput1').focus();
            })
        });
    ...
    $('#ChamberCode').on('blur', function () {

    let ChamberCode = $(this).val().trim();
    ...
    // =========================
    $.ajax({
        url: "<?php echo admin_url(); ?>Chamber/GetChamberMasterDetailByID",
        dataType: "JSON",
        method: "POST",
        data: { ChamberCode: ChamberCode },
        ...
        success: function (data) {
            ...
            // =========================
                ...
                $('#ChamberCode').val(data.ChamberCode);
                $('#ChamberName').val(data.ChamberName);
        ...
        $(document).on('click', '.get_ChamberMaster', function () {
            ChamberCode = $(this).attr("data-id");
            $.ajax({
                url:"<?php echo admin_url(); ?>Chamber/GetChamberMasterDetailByID",
                dataType:"JSON",
                method:"POST",
            ...
            $('#ChamberMaster_List').modal('hide');
        });
        
    // Save New ItemDivision
        $('.saveBtn').on('click',function(){ 
            ChamberCode = $('#ChamberCode').val();
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>Chamber/SaveChamberMaster",
                dataType:"JSON",
                method:"POST",
                data:{ChamberCode:ChamberCode,
    ...
    // Update Exiting Item Division
        $('.updateBtn').on('click',function(){ 
            ...
            $.ajax({
                url:"<?php echo admin_url(); ?>Chamber/UpdateChamberMaster",
                dataType:"JSON",
                method:"POST",
                data:{ChamberCode:ChamberCode,
                ChamberName:ChamberName,
...
<script>
  ...
  table = document.getElementById("table_ChamberMaster_List");
...
$(document).on("click", ".sortablePop", function () {
		var table = $("#table_ChamberMaster_List tbody");
...
<script>
    ...
    $('#ChamberMastertableBody').load(location.href + ' #ChamberMastertableBody > *');
}
...
#table_ChamberMaster_List td:hover {
    cursor: pointer;
}
#table_ChamberMaster_List tr:hover {
    background-color: #ccc;
}

    .table-ChamberMaster_List          { overflow: auto;max-height: 65vh;width:100%;position:relative;top: 0px; }
    .table-ChamberMaster_List thead th { position: sticky; top: 0; z-index: 1; }
    .table-ChamberMaster_List tbody th { position: sticky; left: 0; }
