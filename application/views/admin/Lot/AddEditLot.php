                    ...
                    <div class="col-md-3">
							...
							<div class="col-md-3">
								<div class="form-group">
									...
									<select class="selectpicker display-block" data-width="100%" id="StackName" name="StackName" data-live-search="true" required>
										<option value="" disabled selected>-- Select Stack Name --</option>
										<?php foreach ($stack as $st) { ?>
										<option value="<?php echo $st['id']; ?>">
                                            <?php echo $st['StackName']; ?>
                                        </option>
										<?php } ?>
									</select>
								</div>
...
#table_LotMaster_List tr:hover {
    ...
    .table-LotMaster_List          { overflow: auto;max-height: 65vh;width:100%;position:relative;top: 0px; }
    .table-LotMaster_List thead th { position: sticky; top: 0; z-index: 1; }
    .table-LotMaster_List tbody th { position: sticky; left: 0; }
