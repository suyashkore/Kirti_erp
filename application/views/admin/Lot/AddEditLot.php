                    ...
                    <div class="panel-body">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><b>Lot Master</b></li>
                            </ol>
                        </nav>
                        <hr class="hr_style">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="searchh3" style="display:none;">Please wait Create new Lot...</div>
                                <div class="searchh4" style="display:none;">Please wait update Lot...</div>
                            </div>
                            <br>
                            <div class="col-md-3">
                                <div class="form-group" app-field-wrapper="LotCode">
                                    <small class="req text-danger">* </small>
                                    <label for="LotCode" class="control-label">Lot Code</label>
                                    <input type="text" id="LotCode" name="LotCode" class="form-control" value="" oninput="this.value = this.value.replace(/[^A-Za-z0-9]/g, '')" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="LotName" id="LotName" class="form-control" value="" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker display-block" data-width="100%"
                                        id="ChamberName" name="ChamberName"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <small class="req text-danger">* </small>
                                    <label for="StackName" class="control-label">Stack Name</label>
                                    <select class="selectpicker display-block" data-width="100%"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label for="TotalArea" class="control-label">Total Area</label>
                            ...
                            <div class="col-md-12">
                                <div class="action-buttons text-left">
                                    <?php if (has_permission('Lot', '', 'create')) {
                                    ?>
                                    ...
                                    <?php if (has_permission('Lot', '', 'edit')) {
                                    ?>
                        ...
                        <div class="modal fade LotMaster_List" id="LotMaster_List" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static">
                            <div class="modal-dialog modal-md" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="padding:0px 5px !important">
                                        ...
                                        <div class="table-LotMaster_List tableFixHead2">
                                            <table class="tree table table-striped table-bordered table-LotMaster_List tableFixHead2" id="table_LotMaster_List" width="100%">
                                                <thead>
                                                    <tr>
                                                        <th class="sortablePop" style="text-align:left;">Lot Code </th>
                                                        <th class="sortablePop" style="text-align:left;">Lot Name</th>
                                                ...
                                                <tbody id="LotMastertableBody">
                                                    <?php
                                                    foreach ($table_data as $key => $value) {
                                                    ?>
                                                        <tr class="get_LotMaster" data-id="<?php echo $value["LotCode"]; ?>">
                                                            <td><?php echo $value["LotCode"]; ?></td>
                                                            <td><?php echo $value["LotName"]; ?></td>
...
<!-- <script>
    ...
    $(document).ready(function() {
        $('.updateBtn').hide();
        $('.updateBtn2').hide();
        $("#LotCode").dblclick(function() {
            $('#LotMaster_List').modal('show');
            $('#LotMaster_List').on('shown.bs.modal', function() {
                $('#myInput1').focus();
            })
        });
        ...
        $(".cancelBtn").click(function() {
            ...
            $('#StackName').val('').selectpicker('refresh');
            $('#length').val('');
            $('#Width').val('');
            $('#Height').val('');
            $('#Margin').val('');
        ...
        $('#LotCode').on('blur', function() {

            let LotCode = $(this).val().trim();
            ...
            // =========================
            $.ajax({
                url: "<?php echo admin_url(); ?>Lot/GetLotMasterDetailByID",
                dataType: "JSON",
                method: "POST",
                data: {
                    LotCode: LotCode
                ...
                success: function(data) {
                    ...
                    // =========================
                        ...
                        $('#ChamberName').val(data.StackName).selectpicker('refresh');
        ...
        $(document).on('click', '.get_LotMaster', function() {
            LotCode = $(this).attr("data-id");
            $.ajax({
                url: "<?php echo admin_url(); ?>Lot/GetLotMasterDetailByID",
                dataType: "JSON",
                method: "POST",
                ...
                success: function(data) {
                    ...
                    $('#GodownName').val(data.GodownName).selectpicker('refresh');
                    $('#ChamberName').val(data.ChamberName).selectpicker('refresh');
                    $('#StackName').val(data.StackName).selectpicker('refresh');
                    $('#length').val(data.Length);
                    $('#Width').val(data.Width);
                    $('#Height').val(data.Height);
                    $('#Margin').val(data.Margin);
        ...
        $('.saveBtn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo admin_url(); ?>Lot/SaveLotMaster",
                dataType: "JSON",
                method: "POST",
                data: {
                    LotCode: LotCode,
        ...
        $('.updateBtn').on('click', function() {
            ...
            $.ajax({
                url: "<?php echo admin_url(); ?>Lot/UpdateLotMaster",
                dataType: "JSON",
                method: "POST",
                data: {
                    LotCode: LotCode,
...
<script>
    function myFunction2() {
        ...
        table = document.getElementById("table_LotMaster_List");
    ...
    $(document).on("click", ".sortablePop", function() {
        var table = $("#table_LotMaster_List tbody");
...
<script>
    ...
    function refreshLotList() {
        $('#LotMastertableBody').load(location.href + ' #LotMastertableBody > *');
    }
</script> -->
...
function loadChambersByGodown(GodownID, selectedChamberID, afterLoad) {
    var $chamber = $('#ChamberName');

    $chamber.empty().append('<option value="" disabled selected>None Selected</option>');
    $chamber.selectpicker('refresh');

    // Also reset Stack when Godown changes
    $('#StackName').empty()
        .append('<option value="" disabled selected>None Selected</option>')
        .selectpicker('refresh');

    if (!GodownID || GodownID == '0' || GodownID == '') {
        if (typeof afterLoad === 'function') afterLoad();
        return;
    }

    $.ajax({
        url: "<?php echo admin_url(); ?>Lot/GetChambersByGodown",
        dataType: "JSON",
        method: "POST",
        ...
        success: function (data) {
            if (data && data.length > 0) {
                $.each(data, function (i, ch) {
                    $chamber.append($('<option>', { value: ch.id, text: ch.ChamberName }));
                });
            }
            $chamber.selectpicker('refresh');

            if (selectedChamberID !== null && selectedChamberID !== undefined && selectedChamberID !== '') {
                setTimeout(function () {
                    $chamber.val(String(selectedChamberID)).selectpicker('refresh');
                    if (typeof afterLoad === 'function') afterLoad();
                }, 50);
            } else {
                if (typeof afterLoad === 'function') afterLoad();
        ...
        error: function () {
            alert_float('danger', 'Failed to load chambers.');
            $chamber.selectpicker('refresh');
        }
    });
}

function loadStacksByChamber(GodownID, ChamberID, selectedStackID) {
    var $stack = $('#StackName');

    $stack.empty().append('<option value="" disabled selected>None Selected</option>');
    $stack.selectpicker('refresh');

    if (!ChamberID || ChamberID == '0' || ChamberID == '') return;

    $.ajax({
        url: "<?php echo admin_url(); ?>Lot/GetStacksByGodownAndChamber",
        dataType: "JSON",
        method: "POST",
        data: { GodownID: GodownID, ChamberID: ChamberID },
        success: function (data) {
            if (data && data.length > 0) {
                $.each(data, function (i, st) {
                    $stack.append($('<option>', { value: st.id, text: st.StackName }));
                });
            }
            $stack.selectpicker('refresh');

            if (selectedStackID !== null && selectedStackID !== undefined && selectedStackID !== '') {
                setTimeout(function () {
                    $stack.val(String(selectedStackID)).selectpicker('refresh');
                }, 50);
            }
        },
        error: function () {
            alert_float('danger', 'Failed to load stacks.');
            $stack.selectpicker('refresh');
        }
    });
}
...
function populateForm(data) {
    ...
    // Load chambers first, then stacks inside the callback
    loadChambersByGodown(data.GodownName, data.ChamberName, function () {
        loadStacksByChamber(data.GodownName, data.ChamberName, data.StackName);
    });
...
$(document).ready(function () {
    ...
    // Double-click LotCode opens list
    $("#LotCode").dblclick(function () {
        $('#LotMaster_List').modal('show');
        $('#LotMaster_List').on('shown.bs.modal', function () {
            $('#myInput1').focus();
    ...
    // Godown change → reload Chambers (and reset Stack)
    $('#GodownName').on('change', function () {
        loadChambersByGodown($(this).val(), null, null);
    });

    // Chamber change → reload Stacks
    $('#ChamberName').on('change', function () {
        var GodownID = $('#GodownName').val();
        loadStacksByChamber(GodownID, $(this).val(), null);
    });

    // Blur on LotCode → fetch record
    $('#LotCode').on('blur', function () {
        let LotCode = $(this).val().trim();
        ...
        $.ajax({
            ...
            beforeSend: function () { $('.searchh2').show().css('color', 'blue'); },
            complete:   function () { $('.searchh2').hide(); },
            success: function (data) {
                if (!data || $.isEmptyObject(data)) {
                    resetForm();
                    $('#LotCode').val(LotCode); // keep typed code for new entry
                    $('.saveBtn, .saveBtn2').show();
                    $('.updateBtn, .updateBtn2').hide();
                } else {
                    populateForm(data);
    ...
    // Click row in modal list
    $(document).on('click', '.get_LotMaster', function () {
        var LotCode = $(this).attr("data-id");
        $.ajax({
            url: "<?php echo admin_url(); ?>Lot/GetLotMasterDetailByID",
            dataType: "JSON",
            method: "POST",
    ...
    $('.saveBtn').on('click', function () {
        ...
        $.ajax({
            ...
            data: {
                ...
                Margin:      Margin,
                TotalArea:   length * Width,
                UtilizeArea: (length * Width) - Margin,
                Volume:      length * Width * Height,
                Capacity:    length * Width * Height,
                IsActive:    $('#IsActive').val()
            },
            beforeSend: function () { $('.searchh3').show().css('color', 'blue'); },
            complete:   function () { $('.searchh3').hide(); },
            success: function (data) {
                if (data == true) {
                    alert_float('success', 'Record created successfully...');
                    resetForm();
    ...
    $('.updateBtn').on('click', function () {
        ...
        $.ajax({
            ...
            beforeSend: function () { $('.searchh4').show().css('color', 'blue'); },
            complete:   function () { $('.searchh4').hide(); },
            success: function (data) {
                if (data == true) {
                    alert_float('success', 'Record updated successfully...');
                    resetForm();
...
<style>
    ...
    #table_LotMaster_List td:hover {
        cursor: pointer;
    }

    #table_LotMaster_List tr:hover {
        background-color: #ccc;
    }

    .table-LotMaster_List {
        overflow: auto;
        max-height: 65vh;
        width: 100%;
        position: relative;
    ...
    .table-LotMaster_List thead th {
        position: sticky;
        top: 0;
        z-index: 1;
    }

    .table-LotMaster_List tbody th {
        position: sticky;
        left: 0;
    }
