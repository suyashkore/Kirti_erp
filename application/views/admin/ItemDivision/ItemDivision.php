                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group" app-field-wrapper="ItemDivisionID">
                                    ...
                                    <input type="text" id="ItemDivisionID" name="ItemDivisionID" required class="form-control" value="<?= $nextItemGroupID; ?>" onkeypress="return isNumber(event)">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <small class="req text-danger">* </small>
                                    <label for="ItemDivisionName">Item Division Name</label>
                                    <input type="text" name="ItemDivisionName" id="ItemDivisionName" class="form-control" value="" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group" app-field-wrapper="ItemDivisionID">
                            ...
                            <div class="col-md-12">
                                <div class="action-buttons text-right">
                                    <?php if (has_permission('ItemDivision', '', 'create')) {
                                    ?>
                                    ...
                                    <?php if (has_permission('ItemDivision', '', 'edit')) {
                                    ?>
                                    ...
                                    <div class="modal-body" style="padding:0px 5px !important">
                                        ...
                                        <div class="table-ItemDivision_List tableFixHead2">
                                            <table class="tree table table-striped table-bordered table-ItemDivision_List tableFixHead2" id="table_ItemDivision_List" width="100%">
                                                ...
                                                <tbody id="itemDivisionTableBody">
                                                    <?php
...
<script>
    $(document).ready(function() {
        ...
        $("#ItemDivisionID").focus(function() {
            ...
            $('#IsActive').val('N').selectpicker('refresh');
        ...
        $(document).on('click', '.get_ItemDivision', function() {
...
<script>
    ...
    function refreshItemDivisionList() {
        $('#itemDivisionTableBody').load(location.href + ' #itemDivisionTableBody > *');
    }
</script>
...
<style>
    ...
    .table-ItemDivision_List thead th {
        position: sticky;
        top: 0;
        z-index: 1;
    }

    .table-ItemDivision_List tbody th {
        position: sticky;
        left: 0;
    }
