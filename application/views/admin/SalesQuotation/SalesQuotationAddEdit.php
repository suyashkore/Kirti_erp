          ...
          <div class="panel-body">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Sales Quotation</b></li>
              </ol>
            </nav>
            <hr class="hr_style">
            <br>
    ...
    <div class="modal-content">
      <div class="modal-header custom-header">
        ...
        <div class="header-top">
          <h4 class="modal-title">Sales Quotation List</h4>
...
$(document).ready(function(){
  ...
  function getNextQuotationNo(callback = null) {
    ...
    $.ajax({
      url: '<?= admin_url('SalesQuotation/getNextQuotationNo'); ?>',
      type: 'POST',
      data: {
  ...
  $('#main_save_form').on('submit', function(e) {
    ...
    $.ajax({
      url: "<?= admin_url(); ?>SalesQuotation/SaveQuotation",
      method: "POST",
      dataType: "JSON",
      data: form_data,
      contentType: false,
  ...
  function getDetails(id) {
    ResetForm();
    $.ajax({
      url: "<?= admin_url(); ?>SalesQuotation/GetSalesQuotationDetails",
      method: "POST",
      dataType: "JSON",
      data: {
        id: id,
