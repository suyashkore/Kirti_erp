...
foreach ($history as $index => $item) {
    ...
    // $html .= '<tr>
    //         <td colspan="2"><b>Total Qty :</b> '   . number_format($inv['TotalQty'], 2)                   . '</td>
    //     <td colspan="2"><b>Total Value :</b> ' . number_format($inv['TotalValue'], 2)                 . '</td>

    //     <td colspan="3"><b>Total Brokerage :</b> ' . number_format($inv['TotalBrokerage'], 2)         . '</td>
    //     <td colspan="3"><b>Market Price :</b> '    . number_format($inv['TotalMarketPrice'], 2)       . '</td>
    //     <td colspan="2"><b>Gross Value :</b> '     . number_format($inv['TotalGrossValue'], 2)        . '</td>
    //     <td colspan="2"><b>TDS Amt :</b> '         . number_format($inv['MasterTDSAmt'], 2)           . '</td>
    // </tr>';
            ...
            <table width="100%" border="0" cellpadding="4" cellspacing="0">
                <tr>
                    <td width="70%" valign="top">
                        <b>Bag Qty:</b> '        . number_format($item['BagQty'], 2)       . '&nbsp;&nbsp;&nbsp;
                        <b>Qty (Qtl):</b> '      . number_format($item['QtyQuintal'], 2)   . '&nbsp;&nbsp;&nbsp;
                        <b>Value:</b> '          . number_format($item['Value'], 2)        . '&nbsp;&nbsp;&nbsp;
                        <b>Brokerage:</b> '      . number_format($item['Brokerage'], 2)    . '&nbsp;&nbsp;&nbsp;
                        <b>Market Levy:</b> '    . number_format($item['MarketLevy'], 2)   . '&nbsp;&nbsp;&nbsp;
                        <b>Round Off:</b> '      . number_format($item['RoundOff'], 2)     . '
                    </td>
