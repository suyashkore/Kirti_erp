...
$html .= '<tr>
    <td colspan="10" align="center" style="font-size:13px; border:1px solid #000;"><b>Sales Order</b></td>
</tr>';
$html .= '</thead>';
...
// ===== ROW 1: SO Info =====
$html .= '<tr>
    <td style="border:1px solid #000;" colspan="2"><b>SO No :</b> ' . $inv->OrderID . '</td>
    <td style="border:1px solid #000;" colspan="2"><b>SO Date :</b> ' . date('d-m-Y', strtotime($inv->TransDate)) . '</td>
...
$html .= '<tr style="border:1px solid #000;">
    ...
    <td style="border:1px solid #000;" colspan="2"><b>Customer Location :</b> ' . $inv->ShippingCityName . '</td>
