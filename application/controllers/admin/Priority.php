...
class Priority extends AdminController
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model('PriorityMaster_Model');
    }
    public function index()
    {
        if (!has_permission_new('Priority', '', 'view')) {
            access_denied('Priority Master');
        }
        ...
        $this->load->view('admin/Priority/AddEditPriority.php', $data);
    }
