...
class SalesInvoice extends AdminController
{
	...
	* ========================= */
	public function index()
	{
		...
		$data['history'] = $this->SalesInvoice_model->getHistoryDetails();
	...
	public function getCustomerDetailsLocation()
	{
		...
		$deliveryorder_list = $this->DO_model->getDeliveryOrderList($customer_id);
		...
		echo json_encode([
			...
			'location' => $locations,
			'deliveryorder_list' => $deliveryorder_list
		]);
	}

	public function getDeliveryOrderListDetails()
	{
		$id = $this->input->post('deliveryorder_id');
		$data = $this->SalesInvoice_model->getDeliveryOrderListDetails($id);
		if ($data) {
			echo json_encode([
				'success' => true,
				'data' => $data
