...
<script>
    ...
    app.options = {};
    app.lang = {};
    app.locale = "<?= $locale_key; ?>";
    app.options.date_format = '<?= $date_format; ?>';
    app.options.time_format =
        '<?= get_option('time_format'); ?>';
    app.options.calendar_first_day =
        '<?= get_option('calendar_first_day '); ?>';
    app.lang.file_exceeds_max_filesize =
        "<?= _l('ticket_form_validation_file_size', bytesToSize('', file_upload_max_size())); ?>";
    app.lang.validation_extension_not_allowed =
        "<?= _l('validation_extension_not_allowed'); ?>";
</script>

<?= app_compile_scripts($assetsGroup); ?>
...
<?= get_custom_fields_hyperlink_js_function();
...
/**
 * Get the logo that should be used in the header.
 *
 * @return string
 */
function get_admin_header_logo_url()
{
