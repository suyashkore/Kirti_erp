...
*
*/
define('APP_BASE_URL', 'https://kirtierp.globalinfocloud.in/');
...
*/
//define('APP_ENC_KEY', 'e35d399e3cf129d20d8cd955e719753a');
 ...
 */
define('APP_DB_USERNAME', 'kirti2erpgl_db_usr');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'V42pA#Z0K*sIiYQ');

/**
 * The name of the database you want to connect to
 */
//define('APP_DB_NAME', 'kirti2erpgl_crm_def');
define('APP_DB_NAME', 'kirti2erpgl_erp_db2');
