...
class Proposals_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        if (empty($data['rel_type'])) {
            unset($data['rel_type'], $data['rel_id']);
        } else {
     ...
     * @param bool  $client is request coming from the client side
     */
     ...
     * @param mixed $id     proposal id
     * @param bool  $client is request coming from client side or not
     *
     * @return bool
     */
     ...
     * @param bool   $attachpdf attach proposal pdf or not
     *
     * @return bool
     */
