...
<style>
  ...
  /* Row hover effect to indicate clickable */
  #table-list tbody tr {
    cursor: pointer;
  }
            ...
            <form action="" method="post" id="filter_list_form">
              <div class="row">
                ...
                <div class="col-md-9 mbot5" style="padding-top: 20px;">
                  ...
                  <?php
                  if (has_permission_new('PurchaseInwardList', '', 'export')) {
                  ...
                  if (has_permission_new('PurchaseInwardList', '', 'print')) {
                  ...
                  <table class="table table-striped table-bordered table-list" id="table-list" width="100%">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th class="sortable">Vehicle Loaded Wt</th>
                        <th class="sortable">Item Wt</th>
                        <th class="sortable">Vehicle Empty Wt</th>
...
<script>
  ...
  function appendRows(rows) {
    ...
    rows.forEach(function(row) {
      // ===== CHANGED: row click -> redirect to Inwards page with load_id param =====
      html += `<tr style="cursor:pointer;" onclick="window.location.href='<?= admin_url('purchase/Inwards') ?>?load_id=${row.id}'">
  ...
  function exportTableToExcel() {
    ...
    $.ajax({
      url: "<?= admin_url('purchase/Inwards/ListExportExcel') ?>",
      type: 'POST',
      data: formData,
      dataType: 'json',
      processData: false,
