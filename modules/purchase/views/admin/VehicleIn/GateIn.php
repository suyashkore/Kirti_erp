          ...
          <div class="panel-body">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
                ...
                <li class="breadcrumb-item active" aria-current="page"><b>Gate In</b></li>
              </ol>
            </nav>
            <hr class="hr_style">
            <br>
              ...
              <div class="row">
                ...
                <div class="col-md-4 mbot5">
                  <div class="form-group" app-field-wrapper="vehicle_no">
                    ...
                    <input type="text" name="vehicle_no" id="vehicle_no" class="form-control" app-field-label="Vehicle No" required title="Examples: 25 BH 1234 AH or MH 01 AB 1234" style="text-transform: uppercase;" oninput="this.value = this.value.toUpperCase().replace(/[^A-Z0-9]/g, '');" onchange="vehicleNoValidation('vehicle_no');">
                  </div>
                </div>
                <div class="col-md-4 mbot5">
                ...
                <div class="col-md-4 mbot5">
                  <div class="form-group" app-field-wrapper="type">
                    ...
                    <select name="type" id="type" class="form-control selectpicker" data-live-search="true" app-field-label="Type">
      ...
      <div class="modal-body" style="padding:5px 5px !important">
        <form action="" method="post" id="filter_list_form">
          <div class="row">
            ...
            <div class="col-md-4 mbot5" style="padding-top: 20px;">
...
<script>
  ...
  function getGateInNo(locationId) {
    ...
    $.ajax({
      url: "<?= admin_url(); ?>purchase/Vehiclein/GetGateInNo",
      method: "POST",
      dataType: "JSON",
      data: {
  ...
  $('#main_save_form').on('submit', function(e) {
    ...
    $.ajax({
      url: "<?= admin_url(); ?>purchase/Vehiclein/SaveGateIn",
      method: "POST",
      dataType: "JSON",
      data: form_data,
      contentType: false,
  ...
  function getDetails(id, row) {
    ...
    ResetForm();
    $.ajax({
      url: "<?= admin_url(); ?>purchase/Vehiclein/GetGateInDetails",
      method: "POST",
      dataType: "JSON",
      data: {
        id: id,
