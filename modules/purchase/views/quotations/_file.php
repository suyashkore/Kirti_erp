            ...
            <div class="row">
               <div class="col-md-12 border-right project_file_area">
                  ...
                  <?php
                     ...
                     if(is_image($path)){ ?>
                  <img src="<?php echo base_url(PURCHASE_PATH.'pur_estimate/'.$file->rel_id.'/'.$file->file_name); ?>" class="img img-responsive img_style">
                  ...
                  <iframe src="<?php echo base_url(PURCHASE_PATH.'pur_estimate/'.$file->rel_id.'/'.$file->file_name); ?>" height="100%" width="100%" frameborder="0"></iframe>
                  <?php } else if(strpos($file->file_name,'.xls') !== false && empty($file->external)){ ?>
                  <iframe src='https://view.officeapps.live.com/op/embed.aspx?src=<?php echo base_url(PURCHASE_PATH.'pur_estimate/'.$file->rel_id.'/'.$file->file_name); ?>' width='100%' height='100%' frameborder='0'>
                  </iframe>
