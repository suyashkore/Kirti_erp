            ...
            <div class="panel_s">
			   ...
			   <nav aria-label="breadcrumb">
    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    					...
    					<li class="breadcrumb-item active" aria-current="page"><b>TDS Report</b></li>
    				</ol>
                </nav>
                <hr class="hr_style">
                <div class="row">
                            ...
                            <table class="tree table table-striped table-bordered table-daily_report tableFixHead2" id="table-daily_report" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="sortable" style="text-align:center;">Purchase Order</th>
                                        <th class="sortable" style="text-align:center;">Purchase Invoice</th>
                                        <th class="sortable" style="text-align:center;">Invoice Date</th>
                                        <th class="sortable" style="text-align:center;">Vendor Bill No</th>
                                        <th class="sortable" style="text-align:center;">Vendor Bill Date</th>
                                        <th class="sortable" style="text-align:left;">Account Name</th>
                                        <th class="sortable" style="text-align:center;">TDS Section</th>
                                        <th class="sortable" style="text-align:center;">TDS%</th>
                                        <th class="sortable" style="text-align:center;">Taxable Amt</th>
                                        <th class="sortable" style="text-align:center;">TDS Amt</th>
                                        <th class="sortable" style="text-align:center;">Bill Amt</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
$(document).ready(function(){
    ...
    {
        $.ajax({
            url:"<?php echo admin_url(); ?>accounting/GetTDSReport",
            dataType:"html",
            method:"POST",
 ...
 <script>
    $("#caexcel").click(function(){
	    ...
	    var to_date = $("#to_date").val();
	    $.ajax({
            url:"<?php echo admin_url(); ?>accounting/ExportTDSReport",
            method:"POST",
            data:{from_date:from_date, to_date:to_date},
            beforeSend: function () {
...
<script type="text/javascript">
    function printPage(){
        ...
        var heading_data = '<table  border="1" cellpadding="0" cellspacing="0" width="100%" class="tree table table-striped table-bordered" style="font-size:12px;"><tbody><tr><td style="text-align:center;" colspan="3"><?php echo $company_detail->company_name; ?></td></tr><tr><td style="text-align:center;" colspan="3"><?php echo $company_detail->address; ?></td></tr>';
         heading_data += '<tr>';
         heading_data += '<td style="text-align:center;"colspan="3">Tax Deducted at Source (TDS) '+html_filter_name+'</td>';
         heading_data += '</tr>';
