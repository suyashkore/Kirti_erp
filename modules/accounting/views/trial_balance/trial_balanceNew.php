                ...
                <hr class="hr_style">
                    <div class="row">
                       <div class="col-md-3">
                        ...
                        ?>     
                          <?php echo render_date_input('as_on','As On Date',$to_date); ?>
                        </div>
                        <div class="col-md-3">
                       <?php $value = (isset($account_detail) ? $account_detail->SubActGroupID1 : ''); ?>
                        <?php echo render_select('Account_Group1',$account_subgroup1,array('SubActGroupID1','SubActGroupName'),'Account Group Name 1',$value,$date_attrs2); ?>
                    </div>
                        <div class="col-md-3">
                       <?php $value = (isset($account_detail) ? $account_detail->SubActGroupID : ''); ?>
                        <?php echo render_select('Account_Group',array(),array('SubActGroupID','SubActGroupName'),'Account Group Name 2',$value,$date_attrs2); ?>
                    </div>
                ...
                <table class="tree table table-striped table-bordered table-trial_bal_report tableFixHead2" id="table-trial_bal_report" width="100%">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th class="sortable" style="text-align:left;">Account SubGroup1</th>
                            <th class="sortable" style="text-align:left;">Account SubGroup2</th>
                            <th class="sortable" style="text-align:left;">Account ID</th>
                            <th class="sortable" style="text-align:left;">Account Name</th>
                            <th class="sortable" style="text-align:left;">Address</th>
                            <th class="sortable" style="text-align:left;">Opening Amount</th>
                            <th class="sortable" style="text-align:left;">Debit Amount</th>
                            <th class="sortable" style="text-align:left;">Credit Amount</th>
                            <th class="sortable" style="text-align:left;">Balance Amount</th><!--
...
$(document).ready(function(){
	...
	$('#Account_Group1').change(function() {
		var SubAccount_Group1 = $(this).val();
		
		
		$('select[name=Account_Group]').html('');
		...
		if(SubAccount_Group1 != ""){
			$.ajax({
				...
				success: function(data) {
					...
					$('select[name=Account_Group]').html(optionsHTML);
					$('.selectpicker').selectpicker('refresh');
				},
			});
			}else{
  ...
  function load_data(as_on)
  {
    ...
    $('#search_data').on('click',function(){
        var as_on = $("#as_on").val();
        var SubgroupID1 = $("#Account_Group1").val();
        var SubgroupID = $("#Account_Group").val();
	    $.ajax({
          url:"<?php echo admin_url(); ?>accounting/load_data_trial_balance_reportNew",
          dataType:"json",
          method:"POST",
          data:{as_on:as_on,SubgroupID1:SubgroupID1,SubgroupID:SubgroupID},
          beforeSend: function () {
