            ...
            <div class="panel_s">
			   ...
			   <nav aria-label="breadcrumb">
    				<ol class="breadcrumb custombreadcrumb" style="background-color:#fff !important; margin-Bottom:0px !important;">
    					...
    					<li class="breadcrumb-item active" aria-current="page"><b>TCS Report</b></li>
    				</ol>
                </nav>
                <hr class="hr_style">
                <div class="row">
                   <div class="col-md-3">
                    ...
                    <div class="col-md-8" style="margin-top: 19px;">
                        ...
                        <?php }?><a class="btn btn-default" href="javascript:void(0);"  onclick="printPage();">Print</a>
                    </div>
                            ...
                            <table class="tree table table-striped table-bordered table-daily_report tableFixHead2" id="table-daily_report" width="100%">
                                <thead>
                                    ...
                                    <tr>
                                        ...
                                        <th class="sortable" style="text-align:center;">Pan Number</th>
                                        <th class="sortable" style="text-align:center;">Invoice ID</th>
                                        <th class="sortable" style="text-align:center;">Bill Date</th>
                                        <th class="sortable" style="text-align:center;">Taxable Amount</th>
                                        <th class="sortable" style="text-align:center;">TCS%</th>
                                        <th class="sortable" style="text-align:center;">TCS Amount</th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
