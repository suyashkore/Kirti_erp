    ...
    <div class="row">
      <div class="panel_s">
        <div class="panel-body">
          ...
          <div class="row">
            <div class="col-md-3">
              <?php echo render_select('ft_account',$accounts,array('AccountID','company'),'acc_account', '', array('multiple' => true, 'data-actions-box' => true), array(), '', '', false); ?>
            </div>
           <!-- <div class="col-md-3">
            ...
            <div class="col-md-3">
              <?php echo render_select('ft_type',$account_types,array('ActGroupID','ActGroupName'),'type', '', array('multiple' => true, 'data-actions-box' => true), array(), '', '', false); ?>
            </div>
            <div class="col-md-3">
              <?php echo render_select('ft_detail_type',$detail_types,array('SubActGroupID','SubActGroupName'),'detail_type', '', array('multiple' => true, 'data-actions-box' => true), array(), '', '', false); ?>
            </div>
            <div class="col-md-3">
              <?php $active = [ 
          ...
          <table class="table table-accounts1">
            <thead>
