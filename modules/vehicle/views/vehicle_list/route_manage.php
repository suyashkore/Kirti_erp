            ...
            <div class="col-md-12">
                <div class="panel_s">
                    ...
                    <div class="panel-body">
                        ...
                        <h4 class="no-margin">Vehicle Route List</h4>
                        ...
                        <div  class="col-md-4 leads-filter-column pull-left">
                            ...
                            <?php echo render_input('Route_Name','Route Name','','text');
                          ...
                          <div  class="col-md-4 leads-filter-column pull-left">
                            ...
                            <?php echo render_input('Kms','Kms','','number');
                           
                           ?> 
                          </div>
                        <?php $vehicle_status = array("Y","N"); ?>
                           <div  class="col-md-4 leads-filter-column pull-left form-group">

                              <label>Active Y/N</label>
                                  <select name="staff" id="staff" data-live-search="true" class="selectpicker" multiple="false" data-actions-box="false" data-width="100%" data-none-selected-text="status">
                     ...
                     <button type="submit" class="btn btn-info">Add Vehicle Route</button>
                  </div> 
...
<script>
    ...
    initDataTable(table_contract, admin_url+'vehicle/table_route', undefined, undefined, ContractsServerParams,<?php echo hooks()->apply_filters('contracts_table_default_order', json_encode(array(1,'asc'))); ?>);
