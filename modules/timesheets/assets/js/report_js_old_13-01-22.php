<script>
	...
	(function(){
		...
		$('select[name="staff_2_fillter2"]').on('change', function() {
		    ...
		    if(dd == ""){
		       /* $('.history_check_in_out2').show();*/
		       // $('.table-history_check_in_out_report2').removeClass('hide');
		       ...
		       gen_reports();
		        ...
		        //$('.table-history_check_in_out_report2').addClass('hide');
		       /* $('.history_check_in_out3').show();
		        $('.history_check_in_out2').hide();*/
		        //alert(dd);
	...
	function init_report(e, type) {
		...
		$('.sorting_2_table2').addClass('hide');
		...
		else if(type == 'history_check_in_out2'){
			$('.filter_fr_22').removeClass('hide');
			$('#report-time').removeClass('hide');   
			$('.sorting_2_table2').removeClass('hide');
	...
	function ratio_check_in_out_by_workplace() {
	 ...
	 function staff_table(){
	 	"use strict";
	 	$('.title_table').text('Check in/out & Location Visit History');
	 //$('.table-history_check_in_out_report3').find("caption").text(" ");
	 $("caption").remove();
	 	...
	 	$('#first_table').addClass('hide');
	 	var staff_id = $('select[name="staff_2_fillter2"]').val();
	 	$.ajax({
		...
		/*$('.table-history_check_in_out_report3').append('<caption style="caption-side: top">A fictional company\'s staff table.<br><p style="text-align:left;">madhav shinde</p></caption>');*/
	 	    initDataTable('.table-history_check_in_out_report3', admin_url + 'timesheets/history_check_in_out_report3', false, false, fnServerParams, [1, 'desc']);
	 ...
	 function travel_reports(){
	 	...
	 	if(dd == ""){
	 	    ...
	 	    $('#second_table1').addClass('hide');
		$('#first_table1').removeClass('hide');
		if ($.fn.DataTable.isDataTable('.table-travel_report')) {
	 	    ...
	 	    $('#first_table1').addClass('hide');
		$('#second_table1').removeClass('hide');
