...
<!-- workplace - root -->
<div class="row sorting_2_table2 hide">
  <div class="filter_fr_22 col-md-3 staff_2_fr2">
   <div class="form-group">
     <label for="annual_leave"><?php echo _l('staff'); ?></label>
     <select name="staff_2_fillter2" class="selectpicker" data-live-search="true"  data-width="100%" data-none-selected-text="<?php echo _l('invoice_status_report_all'); ?>">
...
<!--<div class="filter_fr_22 col-md-3 department_2_fr2">
  <?php echo render_select('department_2_fillter2[]', $department, array('departmentid', 'name'), 'department', '', array('multiple' => true, 'data-live-search' => true), [], '', '', false); ?>
</div>-->
<!--<div class="filter_fr_2 col-md-3 roles_2_fr">
  <?php echo render_select('roles_2_fillter[]', $roles, array('roleid', 'name'), 'role', '', array('multiple' => true, 'data-live-search' => true), [], '', '', false); ?>
</div>
